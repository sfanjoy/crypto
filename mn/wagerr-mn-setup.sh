...
COIN_RELEASE='4.0.0'
COIN_TGZ='https://github.com/wagerr/wagerr/releases/download/v4.0.0/wagerr-4.0.0-x86_64-linux-gnu.tar.gz'
COIN_TAR='wagerr-4.0.0-x86_64-linux-gnu.tar.gz'
COIN_NAME='wagerr'
COIN_PORT=55002
RPC_PORT=55003
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar -zxvf $COIN_TAR
  cd ./$COIN_NAME-$COIN_RELEASE/bin >/dev/null 2>&1
...
function setup_node() {
  ...
  echo -e "${GREEN}Configuring systemd $COIN_NAME Daemon${NC}"
  configure_systemd
